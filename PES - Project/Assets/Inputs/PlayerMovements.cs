...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/PlayerMovements.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CustomInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerInputs"",
            ""id"": ""6d1087e3-3d11-4e63-8e43-dc48980f5b7f"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""edb9dd11-89a9-4307-aebc-05da833b9b23"",
                ...
                },
                {
                    ""name"": ""UpAndDown"",
                    ""type"": ""Value"",
                    ""id"": ""2ec7b943-bc6f-4577-a751-a3b6e55f3e98"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": ""Arrow"",
                    ""id"": ""2c71f95f-1b5b-411e-abcb-039fd3cc4463"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Up"",
                    ""id"": ""33bb5fdb-7290-4eb4-94e5-127d887c2448"",
                ...
                {
                    ""name"": ""Down"",
                    ""id"": ""a005069d-3da0-4de9-b999-2cdde1baf717"",
                ...
                {
                    ""name"": ""Left"",
                    ""id"": ""abe33b04-125b-4376-8180-b2d1906911ab"",
                ...
                {
                    ""name"": ""Right"",
                    ""id"": ""60d0b170-0c67-4193-b63e-2274dc287901"",
                ...
                {
                    ""name"": ""Keyboard"",
                    ""id"": ""a6a4e833-8433-48a6-addc-2020199d45c4"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Up"",
                    ""id"": ""99f2148b-f53e-4b35-8f83-5c153f37b5cf"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Down"",
                    ""id"": ""b3116dd4-32fe-42c6-963c-4b4737eb46b9"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Left"",
                    ""id"": ""7a3f6fa9-6fe3-416f-8fe4-7ee8b3316e6d"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Right"",
                    ""id"": ""d58b7845-4c55-4134-9dbe-9c1ae7300ede"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""870a6f04-3a8c-45b8-b91c-fb4074df8d1e"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""1151f506-5338-4960-9f2d-b9e7d777517c"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""5d56ac07-f839-425b-8c47-95fe1a5268fb"",
                    ""path"": ""<Keyboard>/ctrl"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_PlayerInputs_UpAndDown = m_PlayerInputs.FindAction("UpAndDown", throwIfNotFound: true);
    }

    ~@CustomInputs()
    {
        UnityEngine.Debug.Assert(!m_PlayerInputs.enabled, "This will cause a leak and performance issues, CustomInputs.PlayerInputs.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_PlayerInputs_UpAndDown;
    /// <summary>
    ...
    public struct PlayerInputsActions
    {
        ...
        /// </summary>
        public PlayerInputsActions(@CustomInputs wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "PlayerInputs/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_PlayerInputs_Move;
        /// <summary>
        /// Provides access to the underlying input action "PlayerInputs/UpAndDown".
        /// </summary>
        public InputAction @UpAndDown => m_Wrapper.m_PlayerInputs_UpAndDown;
        /// <summary>
